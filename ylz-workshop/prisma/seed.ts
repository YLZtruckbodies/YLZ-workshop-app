    ...
    data: [
      {
        ...
        color: '#E8681A',
        pin: pin1234,
        access: ['dashboard', 'analytics', 'floor', 'qa', 'coldform', 'cashflow', 'notifications', 'timesheet', 'production', 'keithschedule', 'jobs', 'reports', 'quotes', 'customers', 'sales', 'engineering'],
        canAdvance: true,
        canEdit: true,
        fullAdmin: true,
