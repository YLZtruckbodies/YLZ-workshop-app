            ...
            return (
              <>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: `repeat(${isTrailer ? 3 : 5}, 1fr)`, gap: 12, marginBottom: 8 }}>
                  ...
                  <div key="pivotCentreOverride">
                    <div style={lblStyle}>C/L Pivot to Rear (mm)</div>
                    <input style={inpStyle} value={editCfg['pivotCentreOverride'] as string || (isTrailer ? calcPivotCentre(true, String(editCfg['bodyLength'] || '')) : '235')} onChange={e => setCfgField('pivotCentreOverride', e.target.value)} />
                  </div>
        ...
        <div className="section">
          ...
          <div className="section-body">
            <div className={`field-row ${isTrailer ? 'field-row-3' : 'field-row-5'}`}>
              ...
              <div className="field"><div className="field-lbl">C/L Pivot to Rear (mm)</div><div className="field-val">{c('pivotCentreOverride') || (isTrailer ? calcPivotCentre(true, c('bodyLength') || '') : '235')}</div></div>
