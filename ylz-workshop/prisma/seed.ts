    ...
    data: [
      {
        ...
        color: '#E8681A',
        pin: pin1234,
        access: ['dashboard', 'analytics', 'floor', 'qa', 'coldform', 'cashflow', 'notifications', 'timesheet', 'production', 'keithschedule', 'jobs', 'reports', 'quotes', 'sales', 'engineering'],
        canAdvance: true,
        canEdit: true,
        fullAdmin: true,
      ...
      },
      {
        ...
        color: '#3b9de8',
        pin: pin3456,
        access: ['dashboard', 'analytics', 'keithschedule', 'production', 'floor', 'qa', 'coldform', 'cashflow', 'notifications', 'timesheet', 'jobs', 'reports', 'sales', 'engineering'],
        canAdvance: true,
        canEdit: true,
        fullAdmin: true,
      ...
      },
      {
        ...
        color: '#f5a623',
        pin: pin7777,
        access: ['dashboard', 'production', 'notifications', 'jobs', 'timesheet'],
        canAdvance: false,
        canEdit: false,
        fullAdmin: false,
        defaultScreen: 'production',
